...
#else
#define CONFIG_BOOTCOMMAND "run qspifpga; run bridge_enable_handoff; run qspiload; run qspiboot"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"qspifpga=sf probe ${qspiloadcs}; sf read ${fpgadata} ${qspifpgaaddr} ${fpgadatasize};" \
	        "fpga load ${qspiloadcs} ${fpgadata} ${fpgadatasize}\0" \
